...
- **Global scope**: `C:/Users/tajo9/opencode/Docking-studio/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/tajo9/opencode/Docking-studio/.opencode/notes/`)
...
2. Glob `C:/Users/tajo9/opencode/Docking-studio/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/tajo9/opencode/Docking-studio/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/tajo9/opencode/Docking-studio/.opencode/notes/` — works in any directory
